...
combine = {'birds': ('raven', 'miscellaneous birds', 'quail', "stellar_s jay", 'crow', 'hawk', 'owl')}
exclude = ('dog', 'mountainlion', 'vehicle', 'mouse', 'raccoon', 'pig',
           'unknown', 'multiple', 'fox', 'coyote', 'birds')#'possum', 'birds', 'turkey')
#combine = {'mixed': ('raven', 'miscellaneous_birds', 'quail', "stellars_jay", 'crow', 'hawk', 'owl', 
#    'dog', 'mountainlion', 'vehicle', 'mouse', 'raccoon', 'pig', 'multiple', 'fox', 'coyote', 'possum')}
#combine = {'mixed':('coyote', 'fox')}

#combine = {'mixed': ('dog', 'mountainlion')}
...
if not cv:
    ...
    cross_validate(
            ...
            optimizer=optimizer, dropout_rate=0.5, epochs=5, batch_size=512,
